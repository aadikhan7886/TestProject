package com.maven.OneToOneUniPrimaryKeyJoin;
...
public class OneToOneUniPrimaryKeyJoin {
	public static void main(String[] args) {
		...
		Emp employee2 = new Emp(13, "aadil", 72000.00, 26, mobile2);

		Mobile mobile3 = new Mobile(3, "vivo10", "VIVO", 52000.00);
		Emp employee3 = new Emp(14, "dominic", 62000.00, 27, mobile3);
