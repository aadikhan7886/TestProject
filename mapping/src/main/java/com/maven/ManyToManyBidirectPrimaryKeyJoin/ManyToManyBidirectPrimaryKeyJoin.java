package com.maven.ManyToManyBidirectPrimaryKeyJoin;
...
public class ManyToManyBidirectPrimaryKeyJoin {
	public static void main(String[] args) {
		SessionFactory sessionFactory = new Configuration().configure("hibernateForOracle.cfg.xml").buildSessionFactory();
