package com.maven.OneToOneUniJoinTable;
...
public class OneToOneUniJoinTable {
	public static void main(String[] args) {
		...
		Mobile mobile1 = new Mobile(1, "s7 edge", "Samsung", 52000.00);
		Emp employee1 = new Emp(12, "Sohail", 52000.00, 25, mobile1);

		Mobile mobile2 = new Mobile(2, "XS_10", "iPhone", 82000.00);
		Emp employee2 = new Emp(13, "aadil", 72000.00, 25, mobile2);

		Mobile mobile3 = new Mobile(3, "vivo10", "VIVO", 52000.00);
...
class Emp {
	...
	@JoinTable(name = "Emp_Mobile_Information", joinColumns = @JoinColumn(name = "New_EID", referencedColumnName = "empId"), 
	inverseJoinColumns = @JoinColumn(name = "New_MID", referencedColumnName = "imei"))
...
class Mobile {
	...
	public Mobile(int imei, String mobileModel, String mobileVendor, double mobilePrice) {
		super();
		this.imei = imei;
		this.mobileModel = mobileModel;
		this.mobileVendor = mobileVendor;
