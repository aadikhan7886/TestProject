package com.maven.OneToOneBidirectPrimaryKeyJoin;
...
public class OneToOneBidirectPrimaryKeyJoin {
	public static void main(String[] args) {
		...
		Mobile mobile1 = new Mobile(1, "s7 edge", "Samsung", 52000.00, null);
		Emp employee1 = new Emp(12, "Sohail", 52000.00, 25, mobile1);
		mobile1.setEmp(employee1);
		Mobile mobile2 = new Mobile(2, "XS_10", "iPhone", 82000.00, null);
		Emp employee2 = new Emp(13, "aadil", 72000.00, 25, mobile2);
		mobile2.setEmp(employee2);
		Mobile mobile3 = new Mobile(3, "vivo10", "VIVO", 52000.00, null);
